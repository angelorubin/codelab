    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-col gap-3 bg-gray-900 m-h-1/4">
        ...
        <div className='flex flex-col w-full items-center justify-center mb-8'>
          <input className={`${inter.className}text-white w-10/12 sm:w-11/12 md:w-11/12 lg:w-8/12 xl:w-8/12 2xl:8/12 bg-gray-700 rounded p-2`} placeholder='Pesquisar no bing' />
        </div>
      </div>

      <div className="flex flex-col items-center bg-gray-800 h-screen p-5 gap-5">
        <div className='flex flex-col w-11/12 sm:w-11/12 md:w-11/12 lg:w-8/12 xl:w-8/12 2xl:8/12 gap-4 border-2 rounded-lg p-5 hover:border-primary bg-gray-800'>
          <div className='flex'>
